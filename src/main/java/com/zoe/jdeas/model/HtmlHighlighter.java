 ...
 * All rights reserved.
 *
 * This class is responsible for html syntax highlighting
 *
...
public class HtmlHighlighter implements Utilities {
    ...
    private static String CLOSETAG_PATTERN;
    private static String EQUAL_PATTERN;
    ...
    public HtmlHighlighter() {
        ...
        try {
            Files.lines(Paths.get(location.toURI()).resolve("../classes/jDeas/files/txt/keyWords/html.txt").normalize())
     ...
     * @param codeArea
     */
    public void applyHtmlHighlighter(CodeArea codeArea) {
                                                    ...
                                                    matcher.group("SEMICOLON") != null ? "semicolon" :
                                                            matcher.group("STRING") != null ? "string" :
                                                                    matcher.group("TAG") != null ? "tag" :
                                                                            matcher.group("CLOSE") != null ? "closeTag" :
